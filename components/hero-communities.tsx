...
export function HeroCommunities() {
  return (
    <section
      ...
      data-bg-type="light"
    >
      <div className="relative z-10 px-4 md:px-6 pt-16 pb-20 md:pt-32 md:pb-28">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            >
              ...
              <motion.p
                ...
                className="text-xl md:text-2xl text-gray-900 leading-[1.4] font-semibold"
              >
          ...
          <motion.div
            ...
            className="flex items-center gap-3 lg:gap-4 flex-wrap mt-8 md:mt-10"
          >
            <a
