        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 mt-8 text-sm font-medium text-gray-500 hover:text-gray-900 transition-colors uppercase tracking-widest"
            >
          ...
          >
            <div className="space-y-4">
              ...
              <h3 className="font-sans text-gray-900 leading-[0.95] text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-black tracking-[-0.02em]">
                How Do I{" "}
                <span className="text-gray-600 font-light italic">Stay</span>{" "}
                Connected?
              </h3>
            </div>
            ...
            <div className="space-y-6 max-w-3xl">
              <p className="text-xl md:text-2xl text-gray-700 leading-[1.4] font-light">
                Many of these communities don&apos;t have their own web presence or social media.
                <strong className="font-semibold text-gray-900"> DEVSA has become their voice online</strong> — sharing
                their events, amplifying their work, and connecting them with new members.
              </p>

              <p className="text-base md:text-lg text-gray-500 leading-relaxed">
                Follow us to stay in the loop.{" "}
                <span className="font-semibold text-gray-900">We&apos;re the bridge for a reason.</span>
              </p>
            </div>
          </motion.div>
