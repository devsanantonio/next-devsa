        ...
        >
          ...
          <div className="grid grid-cols-3 lg:grid-cols-6 gap-3 max-w-4xl mx-auto">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group flex flex-col items-center gap-2 p-4 bg-neutral-950 rounded-lg hover:bg-[#5865F2] transition-colors duration-200"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group flex flex-col items-center gap-2 p-4 bg-neutral-950 rounded-lg hover:bg-[#0A66C2] transition-colors duration-200"
            >
              <svg className="w-6 h-6 text-white" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group flex flex-col items-center gap-2 p-4 bg-neutral-950 rounded-lg hover:bg-linear-to-br hover:from-[#833AB4] hover:via-[#E1306C] hover:to-[#F77737] transition-all duration-200"
            >
              <svg className="w-6 h-6 text-white" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group flex flex-col items-center gap-2 p-4 bg-neutral-950 rounded-lg hover:bg-neutral-800 transition-colors duration-200"
            >
              <svg className="w-6 h-6 text-white" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group flex flex-col items-center gap-2 p-4 bg-neutral-950 rounded-lg hover:bg-[#1877F2] transition-colors duration-200"
            >
              <svg className="w-6 h-6 text-white" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group flex flex-col items-center gap-2 p-4 bg-neutral-950 rounded-lg hover:bg-[#FF0000] transition-colors duration-200"
            >
              <svg className="w-6 h-6 text-white" viewBox="0 0 24 24" fill="currentColor">
