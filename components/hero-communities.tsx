        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="relative z-10 flex min-h-[60vh] md:min-h-150 flex-col justify-end p-8 sm:p-10 md:p-14 lg:p-16">
              <p className="text-sm md:text-base font-medium text-white/70 uppercase tracking-[0.2em]">
                Come Full Circle
              </p>
              <h2 className="mt-5 max-w-4xl text-balance font-sans text-white leading-[0.98] text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black tracking-[-0.02em]">
                &ldquo;Where is the tech community in San&nbsp;Antonio?&rdquo;
              </h2>
            </div>
          </motion.div>

          {/* Resolution (left) + inward action (right) */}
          <div className="mt-12 md:mt-16 grid gap-10 md:gap-12 lg:grid-cols-[1.15fr_1fr] lg:gap-16">
            ...
            >
              <p className="text-xl md:text-2xl text-gray-700 leading-[1.4] font-light">
                ...
                <strong className="font-semibold text-gray-900">stay close</strong>
                .
              </p>
