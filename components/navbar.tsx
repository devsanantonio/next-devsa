          ...
          <div className="flex justify-between items-center py-1.5 md:py-1">
            ...
            <div className="flex-1 min-w-0 text-right">
              <h1
                ...
                className="text-responsive-sm md:text-responsive-base lg:text-responsive-lg text-neutral-950 font-black truncate pl-4 cursor-pointer transition-all duration-200 hover:text-neutral-700 active:scale-95"
              >
