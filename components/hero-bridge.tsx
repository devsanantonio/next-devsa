  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="-mx-6 md:mx-0 md:-mt-32 w-full max-w-4xl lg:max-w-6xl shrink-0"
      >
        <Image
      ...
      <div className="md:-mt-48 w-full max-w-3xl text-center shrink-0">
        {/* Animated divider line */}
        <motion.div
          initial={{ scaleX: 0, opacity: 0 }}
          animate={{ scaleX: 1, opacity: 1 }}
          transition={{ duration: 1.2, delay: 0.3, ease: [0.16, 1, 0.3, 1] }}
          className="w-14 sm:w-16 h-0.5 sm:h-1 mx-auto mb-4 sm:mb-6 bg-linear-to-r from-[#f59e0b] via-[#fbbf24] to-[#fcd34d] rounded-full origin-center"
        />
        ...
        <motion.h2
          ...
          className="font-bold text-slate-900 text-3xl md:text-4xl lg:text-5xl mb-3 sm:mb-4 tracking-tight leading-tight"
        >
