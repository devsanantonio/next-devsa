      ...
      <div className="relative z-20 w-full md:max-w-[55%] flex flex-col items-start text-left pl-6 sm:pl-10 md:pl-16 lg:pl-20 py-20 md:py-28">
        ...
        >
          ...
          <div className="space-y-6 max-w-2xl">
            <p className="text-balance text-xl md:text-2xl text-white/70 leading-[1.4] font-normal">
            ...
            <p className="text-balance text-base md:text-lg text-white/65 leading-relaxed">
              Discover{" "}
