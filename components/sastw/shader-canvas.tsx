 ...
 *
 * The props this repo has no use for are gone: `active` (a pause switch for
 * off-screen canvases — this one is one band on one page) and `still` (a frozen
 * frame for the dead circuits on their schedule page).
 */
