/**
 * Anthropic's Claude mark, lifted from next-sasw/lib/tool-marks.ts.
 *
 * One mark rather than that file's fourteen: the mascots on The Model's card
 * only ever spawn this one, and copying the whole tool set over would bring in
 * thirteen logos this site has no use for.
 */
