      ...
      <div className="min-h-dvh bg-white">
        <main className="mx-auto max-w-2xl px-5 sm:px-6 py-16 sm:py-24 text-center">
          ...
          <p className="text-base sm:text-lg text-slate-500 leading-relaxed mb-8 max-w-md mx-auto">
            It&apos;s now pending review by a DEVSA admin. Once approved, it will be shared to Discord, LinkedIn, and go live on the site.
          </p>
          ...
          <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5 sm:p-6 mb-8 text-left max-w-md mx-auto">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-semibold text-slate-900">Pending Admin Review</p>
                  <p className="text-xs text-slate-400">A DEVSA admin will review your listing</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-semibold text-slate-900">Published on DEVSA</p>
                  <p className="text-xs text-slate-400">Goes live at devsa.community/jobs once approved</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-semibold text-slate-900">Shared to Discord</p>
                  <p className="text-xs text-slate-400">Posted to #jobs channel on approval</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-semibold text-slate-900">Shared to LinkedIn</p>
                  <p className="text-xs text-slate-400">Posted to DEVSA org page on approval</p>
                </div>
              </div>
            </div>
          </div>
